...
const CategoryEdit = () => {
    ...
    const editCategory =async(data)=>{
        try{
            ...
            toast.error("Category cannot by edited at this moment.")
    ...
    return (
        ...
        <Container fluid className="px-4">
            <Heading type={"h1"} className="mt-4" value={"Category Edit Form"}></Heading>
            <Breadcrumb data={[
            ...
            <Card className="mb-4">
                ...
                <Card.Body>
                    {
                        loading ? <><Spinner variant="dark" /></>:<CategoryForm  
