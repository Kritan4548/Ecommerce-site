...
import { TableActionButtons } from "../../../component/common/button.component"
const CategoryList = () =>{
    const [data, setData] = useState()
    const [loading, setLoading] = useState(true)
    const [pagination, setPagination] = useState()
  
    const listCategories = async ({page=1,search="", limit=5}) => {
      try {
        setLoading(true)
    ...
    return (
        ...
        <Container fluid className="px-4">
            ...
            <Breadcrumb data={[{title:"Dashboard",link:"/admin"},{title:"Category List",link:null}]}/>
            <Card className="mb-4">
                <Card.Header>
